...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7bd358; // addresses start with "dEoCo"
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(11000000000000000);
const uint64_t TAIL_EMISSION_REWARD                          = UINT64_C(110000000);
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001a18af1a89c01029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101c1557edc194fb034903dcf465c47d696ee2c1e885940ff00bcd77a8dfba0ff01";

const uint8_t  CURRENT_TRANSACTION_VERSION                   =  1;
const uint8_t  BLOCK_MAJOR_VERSION_1                         =  2;
const uint8_t  BLOCK_MAJOR_VERSION_2                         =  3;
const uint8_t  BLOCK_MAJOR_VERSION_3                         =  4;
const uint8_t  BLOCK_MINOR_VERSION_0                         =  5;
